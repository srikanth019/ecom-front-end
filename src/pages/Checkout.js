                        ...
                        <form
                            ...
                            onSubmit={handleSubmit((data) => {
                                ...
                                dispatch(
                                    updateUserAsync({
                                        ...user,
                                        addresses: [...user.addresses, { ...data, id: nanoid() }],
                                    })
                                );
                                reset();
                            })}
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <button
                                                        ...
                                                        className="text-sm font-semibold leading-6 text-gray-900"
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mt-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
